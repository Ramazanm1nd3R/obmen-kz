...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'replace-this-with-a-default-key')
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),               # Формат заголовка авторизации
}
...
WSGI_APPLICATION = 'obmenkz.wsgi.application'
